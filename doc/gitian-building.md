...
Clone the git repositories for bithao and Gitian.
...
in the bithao repository under 'Fetch and create inputs' to install sources which require
...
Gitian builds' in [doc/release-process.md](release-process.md#perform-gitian-builds) in the bithao repository.
...
Output from `gbuild` will look something like
    ...
    From https://github.com/bithao-project/bithao
...
For example:
```bash
URL=https://github.com/thrasher-/bithao.git
...
BTCPATH=/some/root/path/bithao
SIGPATH=/some/root/path/bithao-detached-sigs
...
[bithao-project/gitian.sigs.ltc](https://github.com/bithao-project/gitian.sigs.ltc/) repository, or if that's not possible create a pull
